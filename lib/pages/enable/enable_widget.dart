...
import 'enable_model.dart';
export 'enable_model.dart';

class EnableWidget extends StatefulWidget {
  const EnableWidget({super.key});

  static String routeName = 'enable';
  static String routePath = '/enable';
...
class _EnableWidgetState extends State<EnableWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EnableModel());
  }
